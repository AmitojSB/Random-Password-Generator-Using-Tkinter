...
def low(): 
	...
	medium= string.punctuation+string.ascii_letters
	special_digits = string.digits+string.punctuation+string.ascii_letters
	password = "" 
	...
	# if strength selected is strong 
		...
		for i in range(0, length): 
			password = password + random.choice(special_digits) 
		return password 
	else: 
